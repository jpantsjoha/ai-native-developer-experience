...
- **Skills** — the 14 `.agents/skills/` capabilities, discovered natively.
...
2. Ask "which skills are available?" — the 14 skills should be named, including
   `gcp-well-architected` and `adk-expert`.
